...
/*
      // regular bounds for constrained k-d tree added by Jiang
      const Bounds& regular_core() const                { return regular_core_; } 
      Bounds&       regular_core()                      { return regular_core_; } 
      void set_regular_core(const Bounds& regular_core) { regular_core_ = regular_core; }
*/
      ...
      void      swap(RegularLink& other)                { Link::swap(other); dir_map_.swap(other.dir_map_); dir_vec_.swap(other.dir_vec_); nbr_bounds_.swap(other.nbr_bounds_); std::swap(dim_, other.dim_); wrap_.swap(other.wrap_); std::swap(divs_, other.divs_); /*std::swap(regular_core_, other.regular_core_);*/ std::swap(core_, other.core_); std::swap(bounds_, other.bounds_); }
    ...
    private:
      ...
      //Bounds                    regular_core_; // added by Jiang
      Bounds                    core_;
      Bounds                    bounds_;

...
void CSyncIsabelApp::init(int argc, char **argv) {
  CPTApp_Sync::init(argc, argv);
}

void CSyncIsabelApp::initialize_particles(Block& b,
...
void CSyncIsabelApp::trace_particles(Block& b, 
    std::vector<Particle>& particles, 
    std::map<int, std::vector<Particle> >& unfinished_particles, 
    std::map<int, std::vector<Particle> >& finished_particles)  // TODO no need to make sure destination
{
...
void CSyncIsabelApp::trace_particles_kdtree(Block& b, 
    std::vector<Particle>& particles, 
    std::map<int, std::vector<Particle> >& unfinished_particles, 
...
void CSyncIsabelApp::trace_particles_video(Block& b, 
      std::vector<Particle>& particles, 

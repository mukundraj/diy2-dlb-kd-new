#ifndef _ASYNC_COMM_HG_H
#define _ASYNC_COMM_HG_H
...
class AsyncComm_HG { // not thread-safe. 
public:
  AsyncComm_HG(MPI_Comm comm=MPI_COMM_WORLD, int max_nonblocking_requests=1024);
  ~AsyncComm_HG();
